...
2. [ Research ](#2)
   1. [ Death masks ](#2.1)
     a. [  What is a death mask? ](#2.1.1)
     b. [  L'Inconnue de la Seine ](#2.1.2)
     c. [  Death masks of the famous ](#2.1.3)
   2. [ Herman (Stuuf) Bernard Wiardi Beckman ](#2.2)
     a. [  Who was Stuuf? ](#2.2.4)
     b. [  Origins of Stuuf's death mask ](#2.2.5)
     c. [  Letters to family Beckman ](#2.2.6)
   3 [ What should we archive? ](#2.3)
     a. [ What is important to tell future generations ](#2.3.1)
     b. [ Why is it important to tell? ](#2.3.2)
     c. [ What are the meta topics ](#2.3.3)
     d.[ How to explain meta topics to future generations ](#2.3.4)
   5. [ Transcodings ](#5)
     a. [ 01 - Virtual Tomb ](#5.1)
     b. [ 02 - Visual Narrative ](#5.2)
     c. [ 03 - Interactive Dialogue ](#5.3)
     d. [ 04 - Archiving Physical Objects ](#5.4)
6. [ Reflection ](#6)
7. [ Bibliography ](#7)
